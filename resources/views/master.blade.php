                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            <a href="{{ route('note.index') }}">
                                <i class="fa fa-dashboard"></i> <span>Danh sách Note</span>
                            </a>
                        </li>
                        <li class="treeview">
                            <a href="{{ route('notetype.index') }}">
                                <i class="fa fa-dashboard"></i> <span>Danh sách Note Type</span>
                            </a>
                        </li>
                    </ul>
                </div>
                    ...
                    <li class="dropdown profile_details_drop">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                            <div class="profile_img">
                                <span class="prfil-img"><img src="images/1.jpg" alt=""> </span>
                                <div class="user-name">
                                    <p>Admin Thuận</p>
...
@yield('content')
    <!--footer-->
    <div class="footer">
        <p>&copy; 2021 Glance Design note. All Rights Reserved | Design by <a href="{{ route('note.index') }}" target="_blank">Note application</a></p>
    </div>
    <!--//footer-->
</div>
